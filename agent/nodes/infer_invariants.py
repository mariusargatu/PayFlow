...
_VOCAB = (
    ...
    "- conservation_zero: money is globally conserved: every ledger movement is a "
    "balanced debit/credit pair, so the net change across all accounts is always "
    "zero (debits == credits).\n"
    "- nonneg_balance: no merchant, holds, or platform fee balance ever goes "
    "negative (external settlement, the funding source, may).\n"
